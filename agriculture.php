...
<body>
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6 text-center bg-transparent">
                    ...
                    <img src="images/ar.png" class="img-fluid shadow-lg shadow-md w-80 bg-transparent rounded mx-auto d-block" style="transition: transform 0.5s ease; cursor: pointer;" onmouseover="this.style.transform='scale(1.1)';" onmouseout="this.style.transform='scale(1)';" alt="Contact Image">
                    <!-- </div> -->
                </div>
            </div>
        </div>
    ...
    <div class="container my-5">
            <h2  class="mb-5 text-center" style="font-size: 2.5rem; font-weight: 600; ">Agriculture Store</h2>
        ...
        <div class="filters d-flex flex-column flex-md-row align-items-center justify-content-between mb-4">
            ...
            <select id="type-filter" class="form-select filter-select mb-3 mb-md-0" onchange="filterProducts()">
                ...
                <option value="Fresh Produce">Fresh Produse</option>
            </select>
...
function loadFmcg() {
    fetch('./components/db_conn.php?type=agriculture')
