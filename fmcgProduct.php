  ...
  <link rel="shortcut icon" href="favicon.png">
    ...
    <style>
        ...
        .modal-content {
            ...
            margin: 10% auto; /* Center the modal horizontally and add vertical margin */
            padding: 20px;
        ...
        @media (max-width: 768px) {
            ...
            .modal-content {
                ...
                margin: 5% auto; /* Adjust vertical margin for smaller screens */
            }
        }
...
<body>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        <h1>FMCG Products</h1>
                        <p class="mb-4">We offer a range of reliable FMCG products, from everyday essentials to premium items. Our goal is to provide high-quality, efficient solutions for all your needs.</p>
                        <p><a href="" class="btn btn-secondary me-2">Shop Now</a><a href="realEstate" class="btn btn-white-outline">Explore our RealEstate</a></p>
                    </div>
                </div>
                <div class="col-lg-6 text-center bg-transparent">
                    <!-- <div class="hero-img-wrap"> -->
                    <img src="images/fcg.png" class="img-fluid shadow-lg shadow-md w-80 bg-transparent rounded mx-auto d-block" style="transition: transform 0.5s ease; cursor: pointer;" onmouseover="this.style.transform='scale(1.1)';" onmouseout="this.style.transform='scale(1)';" alt="FMCG Image">
                    <!-- </div> -->
                </div>
            </div>
        </div>
    ...
    <div class="container my-5">
            <h2  class="mb-5 text-center" style="font-size: 2.5rem; font-weight: 600; ">FMCG Products Store</h2>
...
function loadFmcg() {
    fetch('./components/db_conn.php?type=fmcg')
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 shadow-sm" style="background-color: #f5f7fa; border-radius: 10px;">
                                <div class="image-container" style="min-height: 220px; overflow: hidden; border-top-left-radius: 10px; border-top-right-radius: 10px;">
                                    <img src="${item.image_path}" class="card-img-top" alt="${item.name}" style="height: 200px; object-fit: cover; width: 100%; border-top-left-radius: 10px; border-top-right-radius: 10px;">
                                </div>
                               ...
                               <button class="btn btn-dark btn-sm" onclick="buyNow(${item.id}, '${item.name}', '${item.description}', '${item.price}')">Buy Now</button>
...
function filterProducts() {
    ...
    fetch('./components/db_conn.php?type=fmcg')
        ...
        .then(data => {
            ...
            // Apply type filter
            if (typeFilter) {
                filteredData = filteredData.filter(item => item.category === typeFilter);
            }
...
function showProductDetails(productId) {
    fetch(`./components/db_conn.php?type=fmcg&id=${productId}`)
        .then(response => response.json())
        .then(data => {
            ...
            document.getElementById('productImage').innerHTML = `
                <img src="${product.image_path}" class="img-fluid" alt="${product.name}" style="width: 100%; height: auto;">
            `;
